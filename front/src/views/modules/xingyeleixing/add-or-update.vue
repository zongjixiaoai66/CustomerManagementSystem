<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="行业类型" prop="xingyeleixing">
          <el-input v-model="ruleForm.xingyeleixing" 
              placeholder="行业类型" clearable  :readonly="ro.xingyeleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="行业类型" prop="xingyeleixing">
              <el-input v-model="ruleForm.xingyeleixing" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xingyeleixing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xingyeleixingCrossAddOrUpdateFlag = false;
                  this.parent.search();
