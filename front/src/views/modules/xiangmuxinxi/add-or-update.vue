    ...
    >
      <el-row>
        ...
        <el-form-item class="select" v-if="type!='info'"  label="客户名称" prop="kehumingcheng">
          <el-select v-model="ruleForm.kehumingcheng" placeholder="请选择客户名称">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="客户名称" prop="kehumingcheng">
	      <el-input v-model="ruleForm.kehumingcheng"
                placeholder="客户名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="签单金额" prop="qiandanjine">
          <el-input v-model="ruleForm.qiandanjine" 
              placeholder="签单金额" clearable  :readonly="ro.qiandanjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="签单金额" prop="qiandanjine">
              <el-input v-model="ruleForm.qiandanjine" 
                placeholder="签单金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="签单数量" prop="qiandanshuliang">
          <el-input v-model="ruleForm.qiandanshuliang" 
              placeholder="签单数量" clearable  :readonly="ro.qiandanshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="签单数量" prop="qiandanshuliang">
              <el-input v-model="ruleForm.qiandanshuliang" 
                placeholder="签单数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="工号" prop="gonghao">
              <el-input v-model="ruleForm.gonghao" 
                placeholder="工号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="签单人" prop="qiandanren">
          <el-input v-model="ruleForm.qiandanren" 
              placeholder="签单人" clearable  :readonly="ro.qiandanren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="签单人" prop="qiandanren">
              <el-input v-model="ruleForm.qiandanren" 
                placeholder="签单人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="项目进度" prop="xiangmujindu">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xiangmujindu" label="项目进度" prop="xiangmujindu">
                    <span>{{ruleForm.xiangmujindu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kehumingcheng = true;
            continue;
	            	            ...
	            	            if(o=='qiandanjine'){
            this.ruleForm.qiandanjine = obj[o];
	    this.ro.qiandanjine = true;
            continue;
          }
	            	            if(o=='qiandanshuliang'){
            this.ruleForm.qiandanshuliang = obj[o];
	    this.ro.qiandanshuliang = true;
            continue;
          }
	            	            if(o=='xiangmujindu'){
	    ...
	    this.ro.gonghao = true;
            continue;
	            	            ...
	            	            if(o=='qiandanren'){
            this.ruleForm.qiandanren = obj[o];
	    this.ro.qiandanren = true;
            continue;
          }
	                    }
                                                                                                                                                              }
